...
def test_get_enable_maintenance_audit_template_not_found(
    mock_create_template_func):
    mock_client = Mock()
...
def test_get_workload_balancing_audit_template_not_found(
    mock_create_template_func):
    mock_client = Mock()
    mock_client.audit_template.get.side_effect = NotFound
...
def test_check_audit_plans_recommended():
    ...
    watcher_helper._check_audit_plans_recommended(
        mock_client, mock_audit
    )
